...
_TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "zh-TW": {
        ...
        "settings.auto_load_model":        "啟動時自動載入模型",
        "settings.no_network":             "⚠  需要網路連線才能翻譯",
    ...
    "en": {
        ...
        "settings.auto_load_model":        "Auto-load model on startup",
        "settings.no_network":             "⚠  Internet connection required for translation",
